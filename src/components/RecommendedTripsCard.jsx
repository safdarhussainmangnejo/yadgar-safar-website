                ...
                <Card className="cardScale" style={{ width: '17.8rem', marginLeft:'auto', marginRight:'auto'}}>
                  ...
                  <Card.Body>
                    <div className='row g-0'>
                      ...
                      <div className='col-8'>
                          <Card.Title style={{textAlign: "left", display:'grid', paddingBottom:"5px", fontFamily: "sans-serif", fontWeight:"bold"}}>{props.name}</Card.Title>
                      </div>
                      <div className='col-4'>
                          <Card.Title style={{textAlign: "right", display:'grid', paddingBottom:"5px", fontFamily: "sans-serif", fontWeight:"bold"}}>4 Days</Card.Title>
                      </div>
                    ...
                    <div className='row g-0'>
                      ...
                      <div className='col-8'>
                          <Card.Title style={{textAlign: "left", paddingBottom:"5px", fontFamily: "sans-serif"}}>Price: 500Rs</Card.Title>
                      </div>
                      <div className='col-4'>
